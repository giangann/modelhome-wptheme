...
export const projects: ProjectType[] = [
  {
    ...
    description:
      'Dự án goldenplaza nằm trên khu đất diện tích 6,004m2 trong khu vực trung tâm tâm Quận 5, là tâm điểm giao thương giữa các chợ sĩ lớn nhất Sài Thành – mặt đường Nguyễn Trãi. Golden Plaza sở hữu tòa tháp cao đến 35 tầng cung ứng 328 căn hộ cao cấp và có đến 15.000m2 dành cho mặt bằng bán lẻ.',
    slug: 'golden-plaza',
  },
  {
...
export const serviceDetail = [
  {
    title: 'Dịch vụ thiết kế kiến trúc và thi công nội thất',
    description:
    ...
    workFlow: {
      title: 'Quy trình thiết kế Kiến trúc và thi công nội thất',
      step: {
        a: {
